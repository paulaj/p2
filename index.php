    ...
    <div class="col-md-10">
      <div class=" main-panel panel panel-default">
        <div class="panel-body">
            ...
            <h4 class="text-center">Creates XKCD style passwords</h4>
            <br/>
            <div class="row">
              <div class="col-md-1"></div>
              <div class="col-md-5">   
                    ...
                    <div class="panel-body">
                     <form method='POST' action='index.php'>
                        ...
                        <div class="checkbox">
                          ...
                          <input class="form-control" id="favorite" type='text' name='favoriteWord' maxlength="20" placeholder="Enter your favorite word " disabled><br/>
